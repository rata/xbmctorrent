...
@scraper("Peliculas", "http://fbcdn-sphotos-h-a.akamaihd.net/hphotos-ak-frc3/204323_207963335901313_5804989_o.jpg")
@plugin.route("/yify")
@ensure_fanart
@tracked
def yify_index():
    return [
        {"label": "Buscar...", "path": plugin.url_for("yify_search")},
        {"label": "Ver por Genero", "path": plugin.url_for("yify_genres")},

        {"label": "Mas populares", "path": plugin.url_for("yify_movies", sort="seeds", order="desc", quality="all", set=1, limit=MOVIES_PER_PAGE)},
        ...
        {"label": "Mejor rankeadas", "path": plugin.url_for("yify_movies", sort="rating", order="desc", quality="all", set=1, limit=MOVIES_PER_PAGE)},
        ...
        {"label": "Mas recientes", "path": plugin.url_for("yify_movies", sort="date", order="desc", quality="all", set=1, limit=MOVIES_PER_PAGE)},
